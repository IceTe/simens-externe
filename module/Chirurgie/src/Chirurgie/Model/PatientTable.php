			...
			for ( $i=0 ; $i<count($aColumns) ; $i++ )
			{
				if ( $aColumns[$i] != ' ' )
				{
					...
					if ($aColumns[$i] == 'Nom'){
						...
						$html ="<infoBulleVue> <a href='".$tabURI[0]."public/chirurgie/info-patient/id_patient/".$aRow[ $aColumns[$i] ]."'>";
						...
						$html .= "<infoBulleVue> <a href='".$tabURI[0]."public/chirurgie/modifier/id_patient/".$aRow[ $aColumns[$i] ]."'>";
