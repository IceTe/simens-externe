    		...
    		for ($i = 0; $i < count($aColumns); $i ++) {
    			if ($aColumns[$i] != ' ') {
    				...
    				if ($aColumns[$i] == 'Nom') {
    					...
    					$html = "<infoBulleVue> <a href='" . $tabURI[0] . "public/chirurgie/admission-infos-patient-rv?id_cons=" . $aRow['Id_cons'] . "&id_patient=" . $aRow[$aColumns[$i]] . "'>";
            ...
            for ($i = 0; $i < count($aColumns); $i ++) {
                if ($aColumns[$i] != ' ') {
                    ...
                    if ($aColumns[$i] == 'Nom') {
                        ...
                        $html = "<infoBulleVue> <a href='" . $tabURI[0] . "public/chirurgie/modifier-infos-patient-rv?id_cons=" . $aRow['Id_cons'] . "&id_patient=" . $aRow[$aColumns[$i]] . "'>";
            ...
            for ($i = 0; $i < count($aColumns); $i ++) {
                if ($aColumns[$i] != ' ') {
                    ...
                    if ($aColumns[$i] == 'Nom') {
                        ...
                        $html = "<infoBulleVue> <a href='" . $tabURI[0] . "public/chirurgie/info-patient-rv?id_cons=" . $aRow['Id_cons'] . "&id_patient=" . $aRow[$aColumns[$i]] . "'>";
